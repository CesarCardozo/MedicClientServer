...
public class ConstansUI {
	public static final String PATH = new File (".").getAbsolutePath();
	
	public static final int SIZE_WINDOW_X = (400);
	public static final int SIZE_WINDOW_Y = (500);
	public static final int SIZE_WINDOW_LOGIN_X = (200);
